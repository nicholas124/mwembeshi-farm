    ...
    async function fetchEquipment() {
      try {
        ...
        setFormData({
          name: equipment.name || '',
          code: equipment.code || '',
          category: equipment.category || 'HAND_TOOL',
          ...
          lastServiceDate: equipment.lastServiceDate ? new Date(equipment.lastServiceDate).toISOString().split('T')[0] : '',
          nextServiceDate: equipment.nextServiceDate ? new Date(equipment.nextServiceDate).toISOString().split('T')[0] : '',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link
            href={`/dashboard/equipment/${params.id}`}
